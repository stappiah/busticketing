...
class CreateStationAdmin(generics.CreateAPIView):
    permission_classes = [permissions.IsAuthenticated]
    authentication_classes = [authentication.TokenAuthentication]
...
class ListStationAdmin(generics.ListAPIView):
    permission_classes = [permissions.IsAuthenticated]
    authentication_classes = [authentication.TokenAuthentication]
    ...
    def get_queryset(self):
        ...
        return Account.objects.filter(station=station)
